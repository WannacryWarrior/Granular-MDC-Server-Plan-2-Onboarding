...
It's important to remember that the secret sausce here is that the resource level config overrides the Subscription level config. Any new machine introduced into the Subscription will not have this configuration defined (Step 1 and Step 2). 
